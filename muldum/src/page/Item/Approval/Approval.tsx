...
const Approval = () => {
    ...
    const [rejectReason, setRejectReason] =
        useState<string>("구입처를 잘못 입력한 물품");
    ...
    return (
        <>
            <ClubSelector clubs={Clubs} selectedClub={selectedClub} setSelectedClub={setSelectedClub} />
            <_.AddonsArea>
            ...
            {isPossible ? (
            selectedClub ? (
                <ApprovalList selectAll={selectAll} selectedItems={selectedItems} setSelectedItems={setSelectedItems} setAllItemIds={setAllItemIds} />
            ) : (
    ...
    return (
        ...
        {renderContent()}
        <_.ButtonGroup>
            <_.ApplyButton onClick={() => setShowApproveModal(true)} disabled={selectedItems.length === 0} >
            승인하기
            </_.ApplyButton>
            <_.ApplyNobutton onClick={() => setShowRejectModal(true)} disabled={selectedItems.length === 0} >
            거절하기
            </_.ApplyNobutton>
        </_.ButtonGroup>
